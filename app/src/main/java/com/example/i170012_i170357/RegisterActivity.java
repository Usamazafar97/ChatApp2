...
//                                    if (task.isSuccessful()){
//                                        Intent intent = new Intent(RegisterActivity.this,create_profile.class);
...
//                            });
                            ...
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                            startActivity(intent);
                            Toast.makeText(RegisterActivity.this, "Lets create Profile", Toast.LENGTH_SHORT).show();
                        }
                        else{
    ...
    public void onClick(View v){
        Toast.makeText(RegisterActivity.this, "Going to Sign In...", Toast.LENGTH_SHORT).show();
